...
EL_Reinforcedarmor player_reinforcedarmor[MAX_PLAYERS];
...
void Upgrade_Reinforcedarmor::add_to_menu( byte ID , int num , int &Keys , char *menu )
{
...
void EL_Reinforcedarmor::buy_upgrade( )
{
	...
	UTIL_setPoints(pEntity, UTIL_getPoints(pEntity) + data_reinforcedarmor.req_points);
